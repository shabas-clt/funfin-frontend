...
export default function ConfigForm({ config, onSave }) {
  ...
  return (
    <div className="space-y-5">
      <div className="bg-white dark:bg-neutral-950 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-6 max-w-2xl mx-auto">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="bg-white dark:bg-neutral-950 rounded-2xl shadow-[0_2px_10px_rgba(0,0,0,0.04)] p-6 max-w-2xl mx-auto">
