...
const adminMenus = [
  ...
  { header: 'Engagement' },
  { name: 'Signals', path: '/admin/signals', icon: TrendingUp },
  { name: 'Live Chart', path: '/admin/live-chart', icon: LineChart },
      ...
      >
        <div className="flex h-[72px] shrink-0 items-center justify-between px-6 pt-2">
          <div className="flex items-center">
            <img src="/branding/logo-light.png" alt="FunFin" className="h-10 w-auto max-w-[140px] object-contain block dark:hidden" />
            <img src="/branding/logo-dark.png" alt="FunFin" className="h-10 w-auto max-w-[140px] object-contain hidden dark:block" />
          </div>
