    ...
    <header className="h-[72px] shrink-0 bg-white dark:bg-black border-b border-slate-100 dark:border-neutral-800 flex items-center justify-between px-4 lg:px-6 z-10 w-full transition-all">
      ...
      <div className="flex items-center gap-1 sm:gap-3">
        ...
        <div className="relative" ref={dropdownRef}>
          ...
          >
            <img
              src="https://ui-avatars.com/api/?name=Shabas+Rahman&background=6366f1&color=fff&rounded=true"
              alt="Profile"
              className="w-9 h-9 rounded-full shadow-sm"
            />
            <div className="hidden lg:block text-left">
              <p className="text-[13px] font-semibold text-[#0f172a] dark:text-white leading-tight group-hover:text-[#6366f1] transition-colors">Admin</p>
            </div>
          ...
          {profileOpen && (
            <div className="absolute right-0 mt-2 w-[240px] bg-white dark:bg-neutral-950 rounded-xl shadow-[0_4px_24px_rgba(0,0,0,0.12)] border border-slate-100 dark:border-neutral-800 py-4 px-2 z-50">
              <div className="flex items-center gap-3 px-3 pb-4 mb-2 border-b border-slate-100 dark:border-neutral-800">
                ...
                />
                <div>
                  <p className="text-[14px] font-bold text-[#0f172a] dark:text-white">Admin</p>
                  <p className="text-[11px] font-medium text-slate-400">admin@funfin.com</p>
                </div>
              </div>
              ...
              <div className="px-2 pt-3 mt-2">
                <button className="w-full flex items-center justify-center gap-2 px-3 py-2 text-[13px] font-bold text-white bg-[#ef4444] hover:bg-red-600 rounded-lg shadow-sm transition-colors">
